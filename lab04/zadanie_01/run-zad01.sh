...
info "WOLUMEN" "Tworzenie wolumenu Docker o nazwie $volume_name"
...
info "KOPIOWANIE" "Kopiowanie pliku $file_name do wolumenu $volume_name"
docker run --rm -v $volume_name:/nginx_volume -v $(pwd):/tmp ubuntu sh -c "cp /tmp/index.html /nginx_volume"

info "KONTENER" "Tworzenie i uruchamianie kontenera Docker z Nginx i z zamontowanym wolumenem $volume_name"
